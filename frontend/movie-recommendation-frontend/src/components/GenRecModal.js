...
function GenRecModal({ isOpen, onClose, onGenerate }) {
  ...
  const options = {
  "Content Format": ["Movie", "Series", "Mini-series", "Documentary", "Short film", "Web series", "Interactive film", "Anthology", "Live performance", "Animation short", "TV movie", "Limited series", "Event series", "Video essay", "Podcast series"],
